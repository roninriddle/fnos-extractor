...
**本次更新**:
- 🌲 新增目录树选择功能，可展开子目录并选择一个或多个目录扫描
- 🔁 目录选择与“包含子目录”联动，选中父目录即可递归扫描其子目录
- 🧩 `/api/scan` 支持 `paths` 多目录输入，并自动去重重复文件
- 📂 新增 `/api/directories` 懒加载目录接口，避免一次性展开大量目录
- 🧭 命中子目录列表改为安全路径点击，支持特殊字符目录名
- ✅ 本版已整理为正式版 1.3.26
...
**Last Updated**: 2026-06-14 | Version: 1.3.26
